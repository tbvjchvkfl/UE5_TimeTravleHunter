...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnShowWeaponItem, APickUpItem *);
...
public:
	...
	FOnShowWeaponItem OnShowWeaponItem;
	...
	//=					- Functionary -					   =
	//======================================================
	void InitializeWeaponItem(UEquipWeaponWidget* EquipWidget, APickUpItem *WeaponItem);
