...
void APlayerCharacter::Interaction()
{
	...
	if (GetWorld()->LineTraceSingleByChannel(HitTrace, StartPos, EndPos, ECollisionChannel::ECC_GameTraceChannel12, QueryParams))
	{
